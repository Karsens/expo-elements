...
//originally from: https://github.com/jaysoo/react-native-prompt
...
export default class Prompt extends Component {
  ...
  static propTypes = {
    ...
    middleButton: PropTypes.string,
    onPressMiddleButton: PropTypes.func,
      ...
      <View style={styles.dialog} key="prompt">
        ...
        <View style={[styles.dialogContent, { borderColor }, promptStyle]}>
          ...
          <View style={[styles.dialogFooter, { borderColor }]}>
            ...
            {middleButton ? (
              <Touchable onPress={() => onPressMiddleButton()}>
                <View
                  style={[styles.dialogAction, buttonStyle, cancelButtonStyle]}
                >
                  <Text
